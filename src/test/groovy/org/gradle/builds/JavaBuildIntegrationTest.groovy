...
class JavaBuildIntegrationTest extends AbstractIntegrationTest {
    def "can generate single project build"() {
        ...
        app.isApp()
        app.libDir.list() as Set == ["slf4j-api-2.0.18.jar", "slf4j-simple-2.0.18.jar", "testApp.jar"] as Set
        app.succeeds()
    ...
    def "can generate 2 project build"() {
        ...
        def app = build.app("build/install/testApp/bin/testApp")
        app.isApp()
        app.libDir.list() as Set == ["lib.jar", "slf4j-api-2.0.18.jar", "slf4j-simple-2.0.18.jar", "testApp.jar"] as Set
        app.succeeds()
    ...
    def "can generate composite build"() {
        ...
        def app = build.app("build/install/testApp/bin/testApp")
        app.isApp()
        app.libDir.list() as Set == ["childlibapi-1.0.0.jar", "childlibcore-1.0.0.jar", "slf4j-api-2.0.18.jar", "slf4j-simple-2.0.18.jar", "testApp.jar"] as Set
        app.succeeds()
    ...
    def "can generate composite build with 3 builds"() {
        ...
        def app = build.app("build/install/testApp/bin/testApp")
        app.isApp()
        app.libDir.list() as Set == ["childapilibapi-1.0.0.jar", "childapilibcore-1.0.0.jar", "childcorelibapi-1.0.0.jar", "childcorelibcore-1.0.0.jar", "slf4j-api-2.0.18.jar", "slf4j-simple-2.0.18.jar", "testApp.jar"] as Set
        app.succeeds()
