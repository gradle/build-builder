...
public abstract class JvmModelAssembler<A extends Component, L extends Component> extends LanguageSpecificProjectConfigurer<A, L> {
    ...
    static final PublishedLibrary<JavaLibraryApi> slfj4 = new PublishedLibrary<>("slf4j", new ExternalDependencyDeclaration(GeneratorVersions.SLF4J_API), slf4jApi);
    static final PublishedLibrary<JavaLibraryApi> slfj4Simple = new PublishedLibrary<>("slf4j-simple", new ExternalDependencyDeclaration(GeneratorVersions.SLF4J_SIMPLE), new JavaLibraryApi("slaf4-simple", Collections.emptyList()));
