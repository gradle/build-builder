...
import static org.gradle.performance.generator.GradleDsl.DECLARATIVE
import static org.gradle.performance.generator.GradleDsl.KOTLIN
...
class DeclarativeDslTestProjectGenerator extends AbstractTestProjectGenerator {
    ...
    def generateJvmPlugin(File ecosystemPluginDir) {
        ...
        file jvmSourceDir, 'JvmEcosystemPlugin.java', """
            ...
            import ${GradleFeatureApi.REGISTERS_PROJECT_FEATURES};

            @RegistersProjectFeatures(StandaloneJavaApplicationPlugin.class)
        ...
        file javaSourceDir, 'JavaApplication.java', """
            ...
            import ${GradleFeatureApi.DEFINITION};

            /**
             * An application implemented using a single version of Java.
             */
            public interface JavaApplication extends HasJavaTarget, HasJvmApplication, Definition<JavaApplicationModel> {
            }
        """
        ...
        file javaSourceDir, 'JavaApplicationModel.java', """
            ...
            import org.gradle.api.experimental.jvm.HasJavaTarget;
            import org.gradle.api.experimental.jvm.HasJvmApplication;
            import ${GradleFeatureApi.BUILD_MODEL};

            /**
             * An application implemented using a single version of Java.
             */
            public interface JavaApplicationModel extends HasJavaTarget, HasJvmApplication, BuildModel {
            }
        """
        ...
        file javaSourceDir, 'StandaloneJavaApplicationPlugin.java', """
            ...
            import ${GradleFeatureApi.PROJECT_TYPE_BINDING};
            import ${GradleFeatureApi.PROJECT_TYPE_BINDING_BUILDER};
            import ${GradleFeatureApi.PROJECT_TYPE_APPLY_ACTION};
            import ${GradleFeatureApi.PROJECT_FEATURE_APPLICATION_CONTEXT};
            import ${GradleFeatureApi.BINDS_PROJECT_TYPE};
            ...
            abstract public class StandaloneJavaApplicationPlugin implements Plugin<Project> {
                ...
                static abstract class ApplyAction implements ProjectTypeApplyAction<JavaApplication, JavaApplicationModel> {
                    ...
                    @Override
                    public void apply(ProjectFeatureApplicationContext context, JavaApplication definition, JavaApplicationModel model) {
